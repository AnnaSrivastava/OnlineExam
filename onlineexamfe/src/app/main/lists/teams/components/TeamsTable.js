														...
														<Tooltip title="Activate / Deactivate" arrow>
															<Button onClick={(event) => handleDeleteRow(event, n.id)}>
																...
																<Dialog
																	...
																	<DialogContent dividers>Do you want to change this Admin Operator's status? </DialogContent>
																	<DialogActions>
													...
													<TableCell component="th" scope="row" align="left">
														<Button onClick={(event) => handleDeleteRow(event, n.id)}>
															...
															<Dialog
																...
																<DialogContent dividers>Do you want to delete this operator? </DialogContent>
																<DialogActions>
