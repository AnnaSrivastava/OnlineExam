			...
			<List component="span" aria-label="Device settings" className="flex flex-1">
				<Tooltip title="List of Teams" arrow placement="left">
					<ListItem
						...
						<ListItemText primary={<FuseLoading overlay={loading}>{teams[selectedIndex].name}</FuseLoading>} />
			...
			<Dialog
				...
				<DialogContent>
					...
					<Typography variant="subtitle2" component="h6">
						{"Team Name"}
						<Input
							style={{ padding: "5px", marginLeft: "0%", backgroundColor: "gray", border: "2px solid silver", marginBottom: "10px" }}
